...
btn.addEventListener("click", function() {
    ...
    ourRequest.onload = function() { // onload instructs the computer about how to proceed upon loading
        ourData = JSON.parse(ourRequest.responseText); //we are now defining our data, we json for a combination of objects and arrays, it translates the website data to a usable form
